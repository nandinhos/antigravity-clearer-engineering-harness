# Evidências de contrato de hook (sonda v2) — host `agy` (20260925T222340Z)
...
|---|---|---|---|---|---|---|---|---|---|---|
| E10 | 1 | Safety Gate real do CEH: git reset --hard na main (P0/G6) | allow | padrao | True | True (run_command) | False | BLOQUEADO | True | 0 |
