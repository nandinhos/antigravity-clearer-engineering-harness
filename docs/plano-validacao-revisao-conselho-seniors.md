...
**Versão:** 0.26.0
**Estado:** Cluster 1 preservado no commit local `bb61fe7`; Cluster 2 (R6–R8) executado e validado em fixtures, sem commit ou push das alterações do Cluster 2.
...
**Estado de validação:** O Cluster 1 permanece no commit local `bb61fe7` (38 cenários, 42 testes gerais; sem push). O Cluster 2 R6–R8 foi executado neste checkout: as regressões direcionadas passam 3/3, a suíte geral 43/43 e o smoke-eval 5/5 em fixture Git limpa. Rodar `evals/run.sh` diretamente no checkout de trabalho sujo agora falha cedo, conforme o contrato R8. As alterações do Cluster 2 permanecem locais, sem commit e sem push. R3, R4, R9 e R10 continuam fora do escopo.
